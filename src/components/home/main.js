...
const main = () => {
  return (
    <>
      <div className='relative shadow-lg py-12'>
        ...
        <div className='grid grid-cols-2 gap-4 sm:w-4/6 mx-auto p-8 justify-center items-center'>
          <div className='relative w-full h-full'>
            ...
            <div className='bg-gradient-to-b from-orange-600 via-red-500 to-red-500 text-white flex justify-around items-center p-2 px-3 sm:px-6 -translate-y-20 w-fit ml-auto'>
              <h5 className='text-sm'>Add to Blog</h5>
              <img className='w-6 m-2' src='images/add.png' alt='img' />
            </div>
            <img
        ...
        <button className='flex text-sm items-center  text-gray-900 p-1 px-8 rounded-full font-semibold w-fit border-gray-900 border-2 mx-auto'>
          <h5>See More</h5>
          <i className=' p-1 text-gray-900 rounded-full m-2  text-2xl'>
            <IoIosArrowForward />
          </i>
        </button>
        <img
      ...
      <p className='p-4 my-5 text-center text-sm font-semibold text-gray-900'>
        Hear the lastest. <br /> (new products, exclusive offers and other
        suprises)
      </p>
      <div className='grid grid-cols-2 w-5/6 mb-8 mx-auto justify-center items-center border-2 border-gray-900 p-2 sm:w-1/2 '>
        <form className='flex w-5/6 items-center text-sm text-gray-900 font-semibold'>
          <input type='text' className='' placeholder='email address' />
        </form>
        <button className='bg-gray-900  p-3 w-5/6 ml-auto text-white'>
          Subscribe
        </button>
      </div>
    </>
